  ...
  return (
    <>
      <Hero>
        ...
        <HeroTitle>Why Was I Rejected?</HeroTitle>
        <HeroSubtitle>
      ...
      <Features>
        ...
        <FeatureGrid>
          <FeatureCard variant="elevated">
            ...
            <Card.Description>
              Discover missing keywords and skills between your CV and job
              requirements.
            </Card.Description>
          </FeatureCard>
          ...
          <FeatureCard variant="elevated">
            ...
            <Card.Description>
              Get personalized suggestions to improve your CV and increase match
              rates.
            </Card.Description>
          </FeatureCard>
        </FeatureGrid>
