...
const SLIDES_DATA = [
  {
    ...
    description: "Corporate recruiters use bots to auto-reject you. We use AI to reverse-engineer their systems and bypass the filters.",
    animation: "float" as const,
    variant: 0,
  },
  {
    title: "Bot vs Bot Analysis",
    description: "Don't have 5 years of experience? No problem. Our AI translates your academic projects into the exact keywords the ATS wants to see.",
    features: [
      "Beat 95% of ATS systems instantly",
      "Translate university projects to corporate speak",
      "Actionable bypass tactics",
    ],
  ...
  },
  {
    ...
    description: "Stop wasting time on applications that will auto-reject you. Know your bypass score before you even apply.",
    features: [
      "See your match score for each job (0-100%)",
      "Discover exactly which keywords you're missing",
      "Apply only where you have a 70%+ match",
    ],
    animation: "float" as const,
    variant: 2,
  },
  {
    title: "Cover Letters on Autopilot",
    description: "Nobody reads cover letters, but the ATS scans them. Generate perfectly optimized, job-specific letters in seconds.",
    features: [
      "Save 2+ hours per application",
      "Spoon-feed keywords to the ATS bot",
  ...
  {
    title: "Ready to Bypass the System?",
    description: "Start hacking your job search today. Let's get you that first interview.",
    animation: "pulse" as const,
    variant: 0,
  },
];
