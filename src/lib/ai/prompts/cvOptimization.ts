...
- CRITICAL: NEVER hallucinate missing locations. If the original CV does not mention the city for a university or job, DO NOT add it. Leave the location field empty or omit it.
